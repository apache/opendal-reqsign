...
use reqsign_azure_storage::WorkloadIdentityCredentialProvider;
...
#[tokio::test]
async fn test_workload_identity_provider() -> anyhow::Result<()> {
    if !is_test_enabled() {
    ...
    assert_provider_reads_probe(WorkloadIdentityCredentialProvider::new(), live_context()).await
}
